...
### 2. 藏云阁资源搜索 → cncfstack-search
**触发条件：** 涉及藏云阁(cncfstack.com)上的云原生资源搜索。关键词含"藏云阁"、"cncfstack"、"藏云阁搜"等明确指向该站的表达。
```
"在藏云阁搜一下 nginx 镜像"
"cncfstack 上有没有 Redis 的 Helm Chart"
"藏云阁找 Docker 镜像"
"查查藏云阁的 skills 库里有没 mcp-builder"
```

### 3. 社区 Skill 搜索 → search-skills-sh
...
### 6. 跨市场金融 / 宏观 / 非A股 → wb-finance-skill
...
### 7. 通用搜索 / 代码 / 学术 / 技术 / 法律 / 安全 → anysearch
...
```
URL抓取/爬取 → firecrawl
藏云阁(cncfstack.com)搜索 → cncfstack-search
